...
all: bin/test_basic_features bin/compare_vector bin/test_contraction_hierarchy_extra_weight bin/examine_ch bin/test_id_set_queue bin/generate_test_queries bin/generate_random_node_list bin/test_inverse_vector bin/test_nearest_neighbor bin/compute_contraction_hierarchy bin/compute_geographic_distance_weights bin/generate_dijkstra_rank_test_queries bin/test_osm_simple bin/test_customizable_contraction_hierarchy_pinned_query bin/test_nested_dissection bin/encode_vector bin/compute_nested_dissection_order bin/test_bit_vector bin/test_tag_map bin/test_customizable_contraction_hierarchy_perfect_customization bin/generate_constant_vector bin/test_strongly_connected_component bin/osm_extract bin/decode_vector bin/test_google_polyline bin/test_customizable_contraction_hierarchy_reset bin/test_permutation bin/run_dijkstra bin/generate_random_source_times bin/test_dijkstra bin/export_road_dimacs_graph bin/run_contraction_hierarchy_query bin/test_customizable_contraction_hierarchy bin/test_contraction_hierarchy_pinned_query bin/show_path bin/test_geo_dist bin/test_customizable_contraction_hierarchy_customization bin/test_buffered_asynchronous_reader bin/test_id_mapper bin/test_customizable_contraction_hierarchy_path_query bin/graph_to_svg bin/graph_to_dot bin/test_sort bin/randomly_permute_nodes bin/test_protobuf bin/convert_road_dimacs_graph bin/convert_road_dimacs_coordinates bin/test_contraction_hierarchy_path_query lib/libroutingkit.a lib/libroutingkit.so
...
build/cch_traffic_modeler.o: include/routingkit/bit_vector.h include/routingkit/cch_traffic_modeler.h include/routingkit/constants.h include/routingkit/customizable_contraction_hierarchy.h include/routingkit/edge_weight.h include/routingkit/id_mapper.h include/routingkit/id_set_queue.h include/routingkit/mapper.h include/routingkit/min_max.h include/routingkit/timer.h src/cch_traffic_modeler.cpp generate_make_file
	@mkdir -p build
	$(CC) $(CFLAGS)  -c src/cch_traffic_modeler.cpp -o build/cch_traffic_modeler.o
...
build/rule_registry.o: include/routingkit/rule_registry.h src/rule_registry.cpp generate_make_file
	@mkdir -p build
	$(CC) $(CFLAGS)  -c src/rule_registry.cpp -o build/rule_registry.o
...
build/mapper.o: include/routingkit/edge_weight.h include/routingkit/mapper.h src/mapper.cpp generate_make_file
	@mkdir -p build
	$(CC) $(CFLAGS)  -c src/mapper.cpp -o build/mapper.o
...
lib/libroutingkit.a: build/bit_select.o build/bit_vector.o build/buffered_asynchronous_reader.o build/cch_traffic_modeler.o build/contraction_hierarchy.o build/customizable_contraction_hierarchy.o build/file_data_source.o build/geo_position_to_node.o build/google_polyline.o build/graph_util.o build/id_mapper.o build/mapper.o build/nested_dissection.o build/osm_decoder.o build/osm_graph_builder.o build/osm_profile.o build/osm_simple.o build/protobuf.o build/rule_registry.o build/strongly_connected_component.o build/timer.o build/vector_io.o
	@mkdir -p lib
	$(AR) rcs lib/libroutingkit.a build/bit_select.o build/bit_vector.o build/buffered_asynchronous_reader.o build/cch_traffic_modeler.o build/contraction_hierarchy.o build/customizable_contraction_hierarchy.o build/file_data_source.o build/geo_position_to_node.o build/google_polyline.o build/graph_util.o build/id_mapper.o build/mapper.o build/nested_dissection.o build/osm_decoder.o build/osm_graph_builder.o build/osm_profile.o build/osm_simple.o build/protobuf.o build/rule_registry.o build/strongly_connected_component.o build/timer.o build/vector_io.o

lib/libroutingkit.so: build/bit_select.o build/bit_vector.o build/buffered_asynchronous_reader.o build/cch_traffic_modeler.o build/contraction_hierarchy.o build/customizable_contraction_hierarchy.o build/file_data_source.o build/geo_position_to_node.o build/google_polyline.o build/graph_util.o build/id_mapper.o build/mapper.o build/nested_dissection.o build/osm_decoder.o build/osm_graph_builder.o build/osm_profile.o build/osm_simple.o build/protobuf.o build/rule_registry.o build/strongly_connected_component.o build/timer.o build/vector_io.o
	@mkdir -p lib
	$(CC) -shared $(LDFLAGS) build/bit_select.o build/bit_vector.o build/buffered_asynchronous_reader.o build/cch_traffic_modeler.o build/contraction_hierarchy.o build/customizable_contraction_hierarchy.o build/file_data_source.o build/geo_position_to_node.o build/google_polyline.o build/graph_util.o build/id_mapper.o build/mapper.o build/nested_dissection.o build/osm_decoder.o build/osm_graph_builder.o build/osm_profile.o build/osm_simple.o build/protobuf.o build/rule_registry.o build/strongly_connected_component.o build/timer.o build/vector_io.o $(OMP_LDFLAGS) -lm -lz -pthread -o lib/libroutingkit.so
